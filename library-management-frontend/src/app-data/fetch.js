import { Configs, ACTION_TYPE, TOKEN_KEY, C, CLIENT_ID_KEY } from '../app-configs';
...
export const getOptions = (options) => {
    ...
    const xClientId = localStorage.getItem(CLIENT_ID_KEY);
    if (xClientId) {
        opts.headers['x-client-id'] = xClientId;
    }
